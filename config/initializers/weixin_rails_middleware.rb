...
WeixinRailsMiddleware.configure do |config|
  ...
  config.weixin_token_string = '6c88da1b9642e663911429be'
  # using to weixin server url to validate the token can be trusted.
  config.weixin_secret_string = 'cb0f0f08c378c4c8e90e65132193d709'
  # 加密配置，如果需要加密，配置以下参数
  config.encoding_aes_key = 'm8LXzdKDkLRv5lrJKfGQyyYH0HLLeJTeuMRsqUV5QiV'
  config.app_id = "wxb5074acfd1eb290f"
